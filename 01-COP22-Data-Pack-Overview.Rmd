...
spectrum_schema <- tibble::tribble(
  ~sheet_name, ~col_ref, ~col, ~col_name, ~value_type, ~prepopulated, ~enter_or_modify, ~calculated, ~linked,
  "Spectrum", "D", 4, "psnu", "string", "N", "Y", "N", "N",
  "Spectrum", "E", 5, "psnu_uid", "string", "N", "Y", "N", "N",
  "Spectrum", "F", 6, "area_id", "string", "N", "Y", "N", "N",
  "Spectrum", "G", 7, "indicator_code", "string", "N", "Y", "N", "N",
  "Spectrum", "H", 8, "dataelement_uid", "string", "N", "Y", "N", "N",
  "Spectrum", "I", 9, "age", "string", "N", "Y", "N", "N",
  "Spectrum", "J", 10, "age_uid", "string", "N", "Y", "N", "N",
  "Spectrum", "K", 11, "sex", "string", "N", "Y", "N", "N",
  "Spectrum", "L", 12, "sex_uid", "string", "N", "Y", "N", "N",
  "Spectrum", "M", 13, "calendar_quarter", "string", "N", "Y", "N", "N",
  "Spectrum", "N", 14, "value", "integer", "N", "Y", "N", "N",
  "Spectrum", "O", 15, "age_sex_rse", "percentage", "N", "Y", "N", "N",
  "Spectrum", "P", 16, "district_rse", "percentage", "N", "Y", "N", "N",
  "Spectrum", "Q", 17, "ID", "string", "N", "N", "Y", "N",
)

schema <- datapackr::cop22_data_pack_schema %>%
  dplyr::filter(!sheet_name %in% c("Home", "Summary",
...
|           | Group 1 | Group  | Group  |           | Pair     |
|           |         | 2      | 3      |           | Track    |
+===========+:=======:+:======:+:======:+===========+:========:+
| 1st Draft | Feb 28  | Mar 7  | Mar 14 | Mar 7 or  | Feb 28   |
| Tool      |         |        |        |           |          |
| S         |         |        |        | Mar 14    |          |
| ubmission |         |        |        |           |          |
+-----------+---------+--------+--------+-----------+----------+
| COP       | Mar     | Mar    | Mar    | Mar 14-18 | Mar      |
| Meeting   | 7-11    | 14-18  | 22-25  | or Mar    | 22-25    |
|           |         |        |        | 22-25     |          |
+-----------+---------+--------+--------+-----------+----------+
| Mid-point |         |        |        |           |          |
| Tool      |         |        |        |           |          |
| check     |         |        |        |           |          |
+-----------+---------+--------+--------+-----------+----------+
| Tools Due | Apr 4   | Apr 11 | Apr 18 | Apr 11 or | Apr 18   |
| for Final |         |        |        |           |          |
| Review    |         |        |        | Apr 18    |          |
+-----------+---------+--------+--------+-----------+----------+
| A         |         |        |        |           | Rolling  |
...
| M/FI-NG   |         |        |        |           |          |
+-----------+---------+--------+--------+-----------+----------+
| COP21     | Apr 19  | Apr 22 | Apr 29 | Apr 22 or | Apr 29   |
| S         |         |        |        |           |          |
| ubmission |         |        |        | Apr 29    |          |
| Due       |         |        |        |           |          |
+-----------+---------+--------+--------+-----------+----------+
...
-   Country Teamspre-validates their DataPack submission in the DataPack
    Self-Service App (available at datapack.datim.org).
...
4.  It may also be the case that together with your PPM and DUIT Liaison
    ...
    DATIM, but still necessary in the DataPack. This is an extraordinary
    circumstance and must have approval from DUIT Liaisons to allow. If
    approved, you may make changes directly in the related column of the
    DataPack.
