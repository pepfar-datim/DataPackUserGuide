...
```{r echo=FALSE}
schema_table(sheet_name = "HTS_RECENT",
             section = "Index (Community)",
             columns = col_seq("N", "O"),
             is_html_knit = knitr::is_html_output())
```
...
```{r echo=FALSE}
schema_table(sheet_name = "HTS_RECENT",
             section = "HTS_RECENT (Total)",
             columns = col_seq("AJ", "AL"),
             is_html_knit = knitr::is_html_output())
```
...
```{r echo=FALSE}
schema_table(sheet_name = "TX_TB_PREV",
             section = "TX_TB (D)",
             columns = col_seq("F", "O"),
             is_html_knit = knitr::is_html_output())
```
...
```{r echo=FALSE}
schema_table(sheet_name = "KP_MAT",
             section = "KP_MAT",
             columns = col_seq("E", "K"),
             is_html_knit = knitr::is_html_output())
```
...
```{r echo=FALSE}
schema_table(sheet_name = "KP Validation",
             section = "PrEP_CT",
             columns = col_seq("C", "J"),
             is_html_knit = knitr::is_html_output())
```
...
```{r echo=FALSE, out.width = '70%', include = !knitr::is_latex_output()}
