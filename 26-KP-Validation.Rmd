...
1.  Review the Total Population targets in the "Female, 15+ (FY24)", "AGYW, 15+ (FY24)", and "Male, 15+ (FY24)" columns, which sum targets across all 15+ age groups from where these are set in previous tabs of the DataPack.
...
2.  Review each column of the KP Targets Validation section. Data for these columns come originally from the KP tab of the DataPack. Return to that tab to investigate and adjust values. Changes made in this section of the KP Validation tab WILL NOT affect actual targets in the KP tab.

3.  Review the "FSW" column and ensure the total in this column does not exceed the total target for "Female, 15+ (FY24)". Cases where this does occur will be highlighted red.

4.  Review the "MSM" column and ensure the total in this column does not exceed the total target for "Male, 15+ (FY24)". Cases where this does occur will be highlighted red.
