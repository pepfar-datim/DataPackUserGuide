...
A: In both of the formulas in columns F and G of this tab there is an "@" symbol halfway through the formula. This needs to be removed in order for the formula to work properly. You will need to drag this formula down through both of these columns to have the aggregation work as intended. 
The following should be pasted in Row 15 of each of the respective columns and then dragged down through the entire column:

- TX_CURR (FY23) - Column F: 
$$
=IFERROR(1/(1/SUM(SUMIFS(Cascade!$O:$O,Cascade!$B:$B,$B15,Cascade!$C:$C,IF($C15="<15",{"=<01","01-09","10-14"},{"15-24","25-34","35-49","50+"}),Cascade!$D:$D,$D15))),"")
$$

- TX_NEW (FY24) - Column G:
$$
=IFERROR(1/(1/SUM(SUMIFS(Cascade!$AY:$AY,Cascade!$B:$B,$B15,Cascade!$C:$C,IF($C15="<15",{"=<01","01-09","10-14"},{"15-24","25-34","35-49","50+"}),Cascade!$D:$D,$D15))),"")
$$
...
A: The PSNUxIM tab will only populate with mechanisms that are marked as
