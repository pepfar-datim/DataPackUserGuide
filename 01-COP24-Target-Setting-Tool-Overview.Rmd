...
# COP24 Target Setting Tool Overview

Welcome to the COP24 Target Setting Tool User Manual. The following
...
and other program areas. Please note that the COP24 Target Setting Tool
is mandatory and must be used to set targets for COP24. For COP24, all
...
The COP24 Target Setting Tool supports analysis for all targets by
...
treatment coverage rates by type of PSNU and population prioritization.
 ...
 - Teams must review and revise their PSNU prioritization levels for COP24. 
The COP24 Target Setting Tool assumes a 'test and start' treatment platform.
...
**Teams must not modify the structure of the COP24 Target Setting Tool
...
## Highlighted Changes from COP23 to COP24

The COP24 Target Setting Tool algorithms are largely the same as the COP23
...
## Data Flow and Review Process to COP24 Submission
...
-   Country Team saves Target Setting Tool to SharePoint under the OU's
    HQ Collaboration \> COP 2024 - FY 2025 \> Guidance, Tools, and
