...
1.  Review the Total Population targets in the "Female, 15+ (FY24)", "AGYW, 15+ (FY24)", and "Male, 15+ (FY24)" columns, which sum targets across all 15+ age groups from where these are set in previous tabs of the Target Setting Tool.
