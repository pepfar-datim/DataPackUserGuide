...
-   **Host Country Projected Incidence Rate (FY22) (%)
    \[Incidence_SUBNAT.Rt.T_1\]**: Estimated incidence rate, projected
    as of September 2022.

-   **Host Country Projected New Infections (FY23)
    \[NEW_INFECTIONS_SUBNAT.T_1\]:** Estimated new infections projected
    to occur in FY23, based on projected FY22 Incidence Rates.
...
-   **Host Country Est. ART Patients Tested for VLS (FY22)
    ...
    have been tested for Viral Load Suppression, projected as of
    September 2022.

-   **Host Country Estimated Virally Suppressed ART Patients (FY22)
    \[VL_SUPPRESSED.T_1\]**: Estimated people living with HIV who are on
    ART and have a suppressed viral load, projected as of
    September 2022.
...
```{=tex}
\begin{center} $\frac{PEPFAR\ TX\_PVLS\ (N)\ (FY22\ Targets)}{Host\ Country\ Est.\ PLHIV\ (FY22)}$ \end{center}
```
