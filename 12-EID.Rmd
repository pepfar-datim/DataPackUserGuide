...
1.  For historical context, review FY22 results for Estimated Positivity Rates both for infants tested before 2 months old, and those tested between 2 and 12 months old. These data reflect data as reported currently in DATIM.
...
4.  Review Targeted TX Retention Rate (FY24) (%) which will default to 98%.

5.  Review Targeted % Eligible for VLS Testing (FY24) (%) which will default to 70%.

6.  Review Targeted % Eligible with Access to VLS Testing (FY24) (%) which will default to 100%.

7.  Review Targeted VL Suppression Rate (FY24) (%) which will default to 95%.
...
9.  Review "HIV+ infants linked to ART (FY24)" which is the product of "Total HIV infected infants identified" and Targeted ART Linkage Rate (FY24) (%)from Step 3. Adjust this value with column L. This will be referenced back to the Cascade tab for the \<01 age group.

10. Review "HIV+ infants retained on ART at end of FY24" which is the product of "HIV+ infants linked to ART (FY24)" and Targeted TX Retention Rate (FY24) (%) from Step 4. Adjust this value with column M. This will be referenced back to the Cascade tab for the \<01 age group.

11. Review "HIV+ infants tested for VLS (FY24)" which is the product of "HIV+ infants linked to ART (FY24)" with both Review Targeted % Eligible for VLS Testing (FY24) (%) from Step 5 and Targeted % Eligible with Access to VLS Testing (FY24) (%) from Step 6. Adjust this value with columns N and O. This will be referenced back to the Cascade tab for the \<01 age group.

12. Lastly, review "HIV+ infants Virally Suppressed (FY24)" which is the product of "HIV+ infants tested for VLS (FY24)" and Targeted VL Suppression Rate (FY24) (%) from Step 7. Adjust this value with columns P. This will be referenced back to the Cascade tab for the \<01 age group.
