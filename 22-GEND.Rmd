...
-   **Physical/Emotional Violence (FY24)** $GEND\_GBV.PE.T$

-   **Sexual Violence (FY24)** $GEND\_GBV.S.T$
...
3.  Review FY24 targets for both the "Physical/Emotional Violence" and
    "Sexual Violence" service types. Each of these is calculated as a
    function of the expected change rate multiplied by the FY23 target
    for the related service type. In the case services are planned in
    FY24 where these were not provided in FY23, you may manually enter
    FY24 targets in these columns.
