...
1.  For historical context, review FY22 results, FY23 targets, and FY22
    ...
    from the Cascade tab of the DataPack.

2.  Review and adjust CXCA_SCRN Coverage - Already on ART (FY24) (%) which
    will be defaulted to 33% and Coverage - Initiated on ART (FY24) (%) will
    be defaulted to 100%. 
    determine the
    proportion of HIV positive women currently on treatment that will
    receive cervical cancer screening in COP2120/FY23 implementation
    ...
    specific guidance from your Chair and PPM. To remove all FY24
    cervical cancer targets, set this column to 0%.

3.  Review FY24 targets for CXCA_SCRN and return to steps 1 and 2 to
